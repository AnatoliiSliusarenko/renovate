...
class Vacancy
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="vacancies")
    ...
    public static function addVacancy($em, $transliterater, \Renovate\MainBundle\Entity\User $user, $parameters)
    {
